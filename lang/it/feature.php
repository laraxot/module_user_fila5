...
return [
    ...
    'fields' => [
        'name' => ['label' => 'Nome', 'tooltip' => 'Nome della feature', 'placeholder' => 'Inserisci il nome della feature', 'helper_text' => 'Nome identificativo della feature', 'description' => 'Nome della feature o funzionalità'],
        'guard_name' => ['label' => 'Guard', 'tooltip' => 'Nome del guard', 'placeholder' => 'Seleziona il guard', 'helper_text' => 'Sistema di autenticazione per questa feature', 'description' => 'Nome del guard (web, api, ecc.)'],
        'permissions' => ['label' => 'Permessi', 'tooltip' => 'Permessi associati', 'placeholder' => 'Seleziona i permessi', 'helper_text' => 'Elenco dei permessi per questa feature', 'description' => 'Permessi associati alla feature'],
        'updated_at' => ['label' => 'Aggiornato il', 'tooltip' => 'Data di ultimo aggiornamento', 'helper_text' => 'Data dell\'ultimo aggiornamento', 'description' => 'Timestamp dell\'ultima modifica'],
        'first_name' => ['label' => 'Nome', 'tooltip' => 'Nome dell\'utente', 'placeholder' => 'Inserisci il nome', 'helper_text' => 'Nome dell\'utente', 'description' => 'Nome di battesimo'],
        'last_name' => ['label' => 'Cognome', 'tooltip' => 'Cognome dell\'utente', 'placeholder' => 'Inserisci il cognome', 'helper_text' => 'Cognome dell\'utente', 'description' => 'Cognome dell\'utente'],
        'select_all' => [
...
<<<<<<< HEAD
        'value' => ['label' => 'Valore', 'tooltip' => 'Valore della feature', 'placeholder' => 'Inserisci il valore', 'helper_text' => 'Valore associato alla feature', 'description' => 'Valore della feature'],
        'toggleColumns' => ['label' => 'Colonne', 'tooltip' => 'Mostra/nascondi colonne', 'helper_text' => 'Azione per mostrare o nascondere le colonne', 'description' => 'Toggle per le colonne della tabella'],
        'reorderRecords' => ['label' => 'Riordina', 'tooltip' => 'Riordina i record', 'helper_text' => 'Azione per riordinare i record', 'description' => 'Funzionalità di riordinamento'],
        'resetFilters' => ['label' => 'Reimposta Filtri', 'tooltip' => 'Reimposta i filtri', 'helper_text' => 'Azzera tutti i filtri attivi', 'description' => 'Reimposta i filtri ai valori predefiniti'],
        'applyFilters' => ['label' => 'Applica Filtri', 'tooltip' => 'Applica i filtri', 'helper_text' => 'Applica i filtri selezionati', 'description' => 'Applica i filtri alla tabella'],
        'openFilters' => ['label' => 'Apri Filtri', 'tooltip' => 'Apri il pannello filtri', 'helper_text' => 'Apre il pannello dei filtri', 'description' => 'Apre il pannello dei filtri'],
        'type' => ['label' => 'type'],
        'active' => ['label' => 'active'],
...
>>>>>>> 350420cb (Check & fix styling)
    ...
    'actions' => [
        'import' => [
            ...
            'fields' => [
<<<<<<< HEAD
                'import_file' => ['label' => 'File Import', 'tooltip' => 'Seleziona un file da importare', 'placeholder' => 'Seleziona un file XLS o CSV da caricare', 'helper_text' => 'Seleziona un file XLS o CSV da caricare', 'description' => 'File contenente i dati da importare'],
=======
                'import_file' => [
                    'label' => 'File Import',
...
<<<<<<< HEAD
            'filename_prefix' => ['label' => 'Prefisso Nome File', 'tooltip' => 'Prefisso per il nome del file', 'placeholder' => 'Inserisci il prefisso', 'helper_text' => 'Prefisso per il nome del file esportato', 'description' => 'Prefisso del nome file'],
            'columns' => [
