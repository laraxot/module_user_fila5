...
return [
    ...
    'fields' => [
        ...
        'scopes' => ['label' => 'scopes', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'revoked' => ['label' => 'revoked', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'created_at' => ['label' => 'created_at', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'expires_at' => ['label' => 'expires_at', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
    ],
    'navigation' => [
        'name' => 'Oauth Token',
        'plural' => 'Oauth Token',
