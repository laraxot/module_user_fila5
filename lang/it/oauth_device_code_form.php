...
return [
    'fields' => [
        ...
        'user_code' => ['label' => 'user_code', 'placeholder' => 'user_code', 'helper_text' => '', 'description' => 'user_code'],
        ...
        'user_approved_at' => ['label' => 'user_approved_at', 'placeholder' => 'user_approved_at', 'helper_text' => '', 'description' => 'user_approved_at'],
        'last_polled_at' => ['label' => 'last_polled_at', 'placeholder' => 'last_polled_at', 'helper_text' => '', 'description' => 'last_polled_at'],
