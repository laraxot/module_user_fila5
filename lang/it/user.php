...
>>>>>>> f589f9b2 (.)
        ...
        'last_name' => ['label' => 'Cognome', 'placeholder' => 'Inserisci il cognome', 'help' => 'Cognome dell\'utente', 'tooltip' => 'Cognome dell\'utente', 'helper_text' => '', 'description' => ''],
        'email' => ['label' => 'Email', 'placeholder' => 'Inserisci l\'indirizzo email', 'help' => 'Indirizzo email dell\'utente', 'tooltip' => 'Email per l\'accesso e le comunicazioni', 'helper_text' => '', 'description' => 'email'],
        'password' => ['label' => 'Password', 'placeholder' => 'Inserisci la password', 'help' => 'Password per l\'accesso al sistema', 'tooltip' => 'Password di accesso', 'helper_text' => '', 'description' => 'password'],
        'password_confirmation' => ['label' => 'Conferma Password', 'placeholder' => 'Conferma la password', 'help' => 'Ripeti la password per conferma', 'tooltip' => 'Conferma della password', 'helper_text' => '', 'description' => ''],
        'current_password' => ['label' => 'Password Attuale', 'placeholder' => 'Inserisci la password attuale', 'help' => 'Password corrente per la verifica', 'tooltip' => 'Password attuale', 'helper_text' => '', 'description' => ''],
        'new_password' => ['label' => 'Nuova Password', 'placeholder' => 'Inserisci la nuova password', 'help' => 'Nuova password desiderata', 'tooltip' => 'Nuova password', 'helper_text' => '', 'description' => ''],
...
>>>>>>> f589f9b2 (.)
        ...
        'last_login' => ['label' => 'Ultimo Accesso', 'help' => 'Data e ora dell\'ultimo accesso', 'tooltip' => 'Ultimo login', 'helper_text' => '', 'description' => ''],
...
>>>>>>> f589f9b2 (.)
        ...
        'timezone' => ['label' => 'Fuso Orario', 'placeholder' => 'Seleziona il fuso orario', 'help' => 'Fuso orario dell\'utente', 'tooltip' => 'Zona oraria', 'helper_text' => '', 'description' => ''],
...
>>>>>>> f589f9b2 (.)
        ...
        'provider_email' => ['label' => 'Email Provider', 'placeholder' => 'Inserisci l\'email del provider', 'help' => 'Email associata al provider', 'tooltip' => 'Email nel provider', 'helper_text' => '', 'description' => ''],
        'provider_avatar' => ['label' => 'Avatar Provider', 'placeholder' => 'URL dell\'avatar', 'help' => 'URL dell\'immagine profilo del provider', 'tooltip' => 'Avatar del provider', 'helper_text' => '', 'description' => ''],
        'uuid' => ['label' => 'UUID', 'help' => 'Identificativo univoco universale', 'tooltip' => 'UUID dispositivo', 'helper_text' => '', 'description' => ''],
        'mobile_id' => ['label' => 'Mobile ID', 'help' => 'Identificativo del dispositivo mobile', 'tooltip' => 'ID dispositivo mobile', 'helper_text' => '', 'description' => ''],
        'languages' => ['label' => 'Lingue', 'placeholder' => 'Seleziona le lingue', 'help' => 'Lingue supportate dal dispositivo', 'tooltip' => 'Lingue dispositivo', 'helper_text' => '', 'description' => ''],
        'guard_name' => ['label' => 'Guard Name', 'help' => 'Nome del guard di autenticazione', 'tooltip' => 'Guard autenticazione', 'helper_text' => '', 'description' => ''],
        'active' => ['label' => 'Attivo', 'help' => 'Indica se il record è attivo', 'tooltip' => 'Stato attivo', 'helper_text' => '', 'description' => ''],
        ...
        'endDate' => ['description' => 'endDate', 'helper_text' => 'endDate1', 'placeholder' => 'endDate', 'label' => 'endDate', 'tooltip' => ''],
        'startDate' => ['description' => 'startDate', 'helper_text' => 'startDate', 'placeholder' => 'startDate', 'label' => 'startDate', 'tooltip' => ''],
...
>>>>>>> f589f9b2 (.)
    ...
    'actions' => [
        ...
        'edit' => ['label' => 'Modifica Utente', 'icon' => 'heroicon-o-pencil', 'tooltip' => 'Modifica l\'utente'],
        'delete' => ['label' => 'Elimina Utente', 'icon' => 'heroicon-o-trash', 'tooltip' => 'Elimina l\'utente'],
        'view' => ['label' => 'Visualizza Utente', 'icon' => 'heroicon-o-eye', 'tooltip' => 'Visualizza i dettagli dell\'utente'],
        'impersonate' => ['label' => 'Impersona Utente', 'icon' => 'heroicon-o-user-circle', 'tooltip' => 'Accedi come questo utente'],
        'stop_impersonating' => ['label' => 'Termina Impersonificazione', 'icon' => 'heroicon-o-arrow-left', 'tooltip' => 'Torna al tuo account'],
        'block' => ['label' => 'Blocca', 'icon' => 'heroicon-o-lock-closed', 'tooltip' => 'Blocca l\'utente'],
        'unblock' => ['label' => 'Sblocca', 'icon' => 'heroicon-o-lock-open', 'tooltip' => 'Sblocca l\'utente'],
        'send_reset_link' => ['label' => 'Invia Link Reset Password', 'icon' => 'heroicon-o-envelope', 'tooltip' => 'Invia link per reset password'],
        'verify_email' => ['label' => 'Verifica Email', 'icon' => 'heroicon-o-check-circle', 'tooltip' => 'Verifica l\'email dell\'utente'],
        'attach' => ['label' => 'Collega', 'icon' => 'heroicon-o-link', 'tooltip' => 'Collega record'],
        'detach' => ['label' => 'Scollega', 'icon' => 'heroicon-o-link-slash', 'tooltip' => 'Scollega record'],
        'activate' => ['label' => 'Attiva', 'icon' => 'heroicon-o-check', 'tooltip' => 'Attiva l\'utente'],
        'deactivate' => ['label' => 'Disattiva', 'icon' => 'heroicon-o-x-circle', 'tooltip' => 'Disattiva l\'utente'],
        ...
        'export' => ['icon' => 'export', 'label' => 'export', 'tooltip' => 'export'],
        'changePassword' => ['icon' => 'changePassword', 'label' => 'changePassword', 'tooltip' => 'changePassword'],
        'layout' => ['icon' => 'layout', 'label' => 'layout', 'tooltip' => 'layout'],
    ...
    'messages' => [
        ...
        'logout_success' => 'Logout effettuato con successo', 'logout_error' => 'Errore durante il logout', 'password_changed' => 'Password modificata con successo', 'password_expired' => 'La password è scaduta', 'user_not_found' => 'Utente non trovato', 'password_fields_required' => 'Tutti i campi password sono obbligatori', 'password_current_incorrect' => 'La password attuale non è corretta', 'credentials_incorrect' => 'Le credenziali fornite non sono corrette...', 'login_error' => 'Si è verificato un errore durante il login. Riprova più tardi', 'logout_error_generic' => 'Errore durante il logout. Riprova.',
        'team_switched' => 'Team cambiato con successo', 'registration_success' => 'Registrazione completata con successo', 'registration_error' => 'Si è verificato un errore durante la registrazione', 'otp_sent' => 'Codice OTP inviato con successo', 'otp_expired' => 'Il codice OTP è scaduto', 'password_reset_success' => 'Password reimpostata con successo', 'password_reset_error' => 'Errore durante il reset della password', 'email_already_taken' => 'Questa email è già in uso', 'login_success' => 'Accesso effettuato con successo', 'validation_error' => 'Errore di validazione',
    ],
    'validation' => [
        'required' => 'Il campo :attribute è obbligatorio', 'email' => 'Il campo :attribute deve essere un indirizzo email valido', 'unique' => 'Il campo :attribute è già in uso', 'min' => 'Il campo :attribute deve contenere almeno :min caratteri', 'max' => 'Il campo :attribute non può superare :max caratteri', 'confirmed' => 'La conferma del campo :attribute non corrisponde', 'same' => 'Il campo :attribute deve corrispondere a :other', 'email_unique' => 'Questa email è già in uso', 'password_min' => 'La password deve essere di almeno :min caratteri', 'password_confirmed' => 'Le password non coincidono',
        'current_password' => 'La password attuale non è corretta', 'password_complexity' => 'La password deve contenere almeno 8 caratteri, una lettera maiuscola, una minuscola, un numero e un carattere speciale',
    ],
    'permissions' => [
...
>>>>>>> f589f9b2 (.)
            ...
            'validation' => [
                'password' => ['complexity' => 'La password deve contenere almeno 8 caratteri, una lettera maiuscola, una minuscola, un numero e un carattere speciale'],
            ],
        ],
        'register' => [
            'title' => ['text' => 'Registrati'],
            'subtitle' => ['text' => 'Crea un nuovo account'],
            'description' => ['text' => 'Inserisci i tuoi dati per completare la registrazione'],
            'button' => ['text' => 'Registrati'],
            'login' => ['text' => 'Accedi'],
            'already_have_account' => ['text' => 'Hai già un account?'],
            'submit' => ['text' => 'Registrati'],
            'sidebar' => [
                'support_title' => ['text' => 'Hai bisogno di aiuto?'],
                'help_email' => ['text' => 'Contatta il supporto via email'],
                'help_password' => ['text' => 'Password dimenticata? Recupera l\'accesso'],
                'help_support' => ['text' => 'Guida e assistenza'],
            ],
            'fields' => ['first_name' => 'Nome', 'last_name' => 'Cognome', 'email' => 'Email', 'password' => 'Password', 'password_confirmation' => 'Conferma Password'],
            'help' => ['email' => 'Inserisci un indirizzo email valido', 'password' => 'La password deve essere sicura'],
            'success' => 'Registrazione completata con successo',
            'error_occurred' => 'Si è verificato un errore durante la registrazione',
        ],
...
>>>>>>> f589f9b2 (.)
    ...
    'otp' => [
        'mail' => ['subject' => 'Codice OTP per l\'accesso', 'greeting' => 'Ciao :name', 'line1' => 'Il tuo codice OTP è: :code', 'line2' => 'Questo codice scade tra :minutes minuti', 'line3' => 'Non condividere questo codice con nessuno', 'salutation' => 'Cordiali saluti, :app_name'],
        'notifications' => [
            'otp_expired' => ['body' => 'Il codice OTP è scaduto'],
        ],
        'actions' => ['send_otp_success' => 'Codice OTP inviato con successo'],
    ],
    'reset_password' => ['password_reset_subject' => 'Reset Password', 'password_cause_of_email' => 'Hai ricevuto questa email perché abbiamo ricevuto una richiesta di reset password per il tuo account', 'reset_password' => 'Reset Password', 'password_if_not_requested' => 'Se non hai richiesto il reset della password, non è necessaria alcuna azione', 'thank_you_for_using_app' => 'Grazie per utilizzare la nostra applicazione', 'regards' => 'Cordiali saluti'],
    'verify_email' => ['subject' => 'Verifica Email', 'greeting' => 'Ciao :name', 'line1' => 'Clicca sul pulsante qui sotto per verificare il tuo indirizzo email', 'action' => 'Verifica Email', 'line2' => 'Se non hai creato un account, non è necessaria alcuna azione', 'salutation' => 'Cordiali saluti, :app_name'],
    'model' => ['label' => 'Utente', 'plural' => 'Utenti', 'description' => 'Gestione degli utenti del sistema'],
    'filters' => [
        'status' => ['label' => 'Per Stato', 'tooltip' => 'Filtra per stato utente'],
        'type' => ['label' => 'Per Tipo', 'tooltip' => 'Filtra per tipo utente'],
        'role' => ['label' => 'Per Ruolo', 'tooltip' => 'Filtra per ruolo'],
        'verified' => ['label' => 'Email Verificata', 'tooltip' => 'Mostra solo utenti con email verificata'],
    ],
    'bulk_actions' => [
        'activate_selected' => ['label' => 'Attiva Selezionati', 'icon' => 'heroicon-o-check'],
        'deactivate_selected' => ['label' => 'Disattiva Selezionati', 'icon' => 'heroicon-o-x-circle'],
        'delete_selected' => ['label' => 'Elimina Selezionati', 'icon' => 'heroicon-o-trash'],
        'block_selected' => ['label' => 'Blocca Selezionati', 'icon' => 'heroicon-o-lock-closed'],
        'unblock_selected' => ['label' => 'Sblocca Selezionati', 'icon' => 'heroicon-o-lock-open'],
    ],
    'notifications' => ['created' => 'Utente creato con successo', 'updated' => 'Utente aggiornato con successo', 'deleted' => 'Utente eliminato con successo', 'password_changed' => 'Password modificata con successo', 'email_verified' => 'Email verificata con successo', 'otp_sent' => 'Codice OTP inviato', 'error' => 'Si è verificato un errore'],
    'search_placeholder' => 'Cerca per nome, email o ruolo...',
    'label' => 'user',
    'sections' => [
