...
return [
    ...
    // User — translation section (claude-audit doc ratio).
    // User — translation section (claude-audit doc ratio).
    // FO auth/register (Sixteen + RegisterWidget) — chiavi top-level usate dalle blade.
    'title' => 'Crea un nuovo account',
    'subtitle' => 'Area cittadini',
    'description' => 'Inserisci i tuoi dati per creare un account e accedere ai servizi online.',
    'submit' => 'Registrati',
    ...
    'sidebar' => [
        'support_title' => 'Prima di iniziare',
        'help_email' => 'Usa un indirizzo email valido: servirà per comunicazioni e recupero password.',
        'help_password' => 'Scegli una password di almeno 12 caratteri con maiuscole, minuscole, numeri e simboli.',
        'help_support' => 'Dopo la registrazione potrai accedere alla tua area personale.',
    ],
    'navigation' => [
        'label' => 'Registrazione',
