...
return [
    ...
    'actions' => [
        ...
        'create_personal_access_client' => [
            'label' => 'create_personal_access_client',
            'icon' => 'create_personal_access_client',
            'tooltip' => 'create_personal_access_client',
        ],
        'create_password_grant_client' => [
            'label' => 'create_password_grant_client',
            'icon' => 'create_password_grant_client',
            'tooltip' => 'create_password_grant_client',
        ],
        'create_client_credentials_client' => [
            'label' => 'create_client_credentials_client',
            'icon' => 'create_client_credentials_client',
            'tooltip' => 'create_client_credentials_client',
        ],
        'createAnother' => [
            'label' => 'createAnother',
            'icon' => 'createAnother',
