...
return [
    ...
    'fields' => [
        ...
        'password_client' => ['label' => 'Client Password', 'tooltip' => 'Tipo client password', 'helper_text' => 'Indica se è un client di tipo password', 'description' => 'Flag per client di tipo password'],
    ...
    'actions' => [
        'create' => ['label' => 'Crea Client', 'tooltip' => 'Crea un nuovo client', 'helper_text' => 'Crea un nuovo client OAuth', 'description' => 'Azione per creare'],
        'edit' => ['label' => 'Modifica Client', 'tooltip' => 'Modifica il client', 'helper_text' => 'Modifica il client esistente', 'description' => 'Azione per modificare'],
        'delete' => ['label' => 'Elimina Client', 'tooltip' => 'Elimina il client', 'helper_text' => 'Elimina il client', 'description' => 'Azione per eliminare'],
