...
<<<<<<< HEAD
    ...
    'resources' => ['label' => 'Risorse', 'tooltip' => 'Risorse del sistema', 'helper_text' => 'Risorse disponibili', 'description' => 'Risorse del sistema'],
    'pages' => ['label' => 'Pagine', 'tooltip' => 'Pagine del sistema', 'helper_text' => 'Pagine disponibili', 'description' => 'Pagine del sistema'],
    'widgets' => ['label' => 'Widgets', 'tooltip' => 'Widget del sistema', 'helper_text' => 'Widget disponibili', 'description' => 'Widgets del sistema'],
    'fields' => [
        'name' => ['label' => 'Nome', 'tooltip' => 'Nome del provider', 'placeholder' => 'Inserisci il nome', 'helper_text' => 'Nome identificativo del provider', 'description' => 'Nome del provider social'],
        'env_guide' => ['label' => 'Guida configurazione .env', 'content' => '1) Crea le credenziali OAuth su Google Cloud Console. 2) Aggiungi GOOGLE_CLIENT_ID e GOOGLE_CLIENT_SECRET nel file .env del server. 3) Esegui: php artisan config:clear && php artisan cache:clear && php artisan optimize:clear. 4) Torna qui e attiva il provider.'],
        'guard_name' => ['label' => 'Guard', 'tooltip' => 'Nome del guard', 'placeholder' => 'Seleziona il guard', 'helper_text' => 'Sistema di autenticazione', 'description' => 'Nome del guard'],
        'permissions' => ['label' => 'Permessi', 'tooltip' => 'Permessi del provider', 'placeholder' => 'Seleziona i permessi', 'helper_text' => 'Permessi associati al provider', 'description' => 'Permessi del provider'],
        'updated_at' => ['label' => 'Aggiornato il', 'tooltip' => 'Data di ultimo aggiornamento', 'helper_text' => 'Data dell\'ultimo aggiornamento', 'description' => 'Timestamp di aggiornamento'],
...
<<<<<<< HEAD
        ...
        'scopes' => ['placeholder' => 'scopes', 'description' => 'scopes'],
        'client_id' => ['helper_text' => 'client_id', 'description' => 'client_id'],
        'client_secret' => ['helper_text' => 'client_secret', 'description' => 'client_secret'],
        'redirect' => ['helper_text' => 'redirect', 'description' => 'redirect'],
        'parameters' => ['placeholder' => 'parameters', 'description' => 'parameters'],
        ...
        'stateless' => ['placeholder' => 'stateless', 'helper_text' => 'stateless', 'description' => 'stateless'],
        'active' => ['placeholder' => 'active', 'helper_text' => 'active', 'description' => 'active'],
        'socialite' => ['placeholder' => 'socialite', 'helper_text' => 'socialite', 'description' => 'socialite'],
        'enabled' => ['label' => 'enabled', 'placeholder' => 'enabled', 'helper_text' => 'enabled', 'description' => 'enabled'],
        'svg' => ['helper_text' => 'svg', 'description' => 'svg'],
