...
return [
    ...
    'fields' => [
        ...
        'id' => ['label' => 'ID', 'help' => 'Identificativo univoco del permesso team', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'created_at' => ['label' => 'Data Creazione', 'help' => 'Data e ora di creazione del permesso', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'updated_at' => ['label' => 'Data Aggiornamento', 'help' => 'Data e ora dell\'ultimo aggiornamento', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
    ],
    'actions' => [
        'create' => ['label' => 'Crea Permesso Team', 'success' => 'Permesso team creato con successo', 'error' => 'Errore durante la creazione del permesso team'],
        ...
        'delete' => ['label' => 'Elimina Permesso Team', 'success' => 'Permesso team eliminato con successo', 'error' => 'Errore durante l\'eliminazione del permesso team', 'confirmation' => 'Sei sicuro di voler eliminare questo permesso team?'],
