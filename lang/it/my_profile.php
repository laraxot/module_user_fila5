...
<<<<<<< HEAD
        ...
        'email' => ['label' => 'email', 'placeholder' => 'email', 'helper_text' => '', 'description' => 'email', 'tooltip' => ''],
        'Current password' => ['label' => 'Current password', 'placeholder' => 'Current password', 'helper_text' => 'Current password', 'description' => 'Current password', 'tooltip' => ''],
        'passwordConfirmation' => ['label' => 'passwordConfirmation', 'placeholder' => 'passwordConfirmation', 'helper_text' => '', 'description' => 'passwordConfirmation', 'tooltip' => ''],
        'current_password' => ['label' => 'current_password', 'placeholder' => 'current_password', 'helper_text' => '', 'description' => 'current_password'],
...
=======
        'name' => ['label' => 'name', 'placeholder' => 'name', 'helper_text' => 'name', 'description' => 'name', 'tooltip' => ''],
        'email' => ['label' => 'email', 'placeholder' => 'email', 'helper_text' => 'email', 'description' => 'email', 'tooltip' => ''],
        'Current password' => ['label' => 'Current password', 'placeholder' => 'Current password', 'helper_text' => 'Current password', 'description' => 'Current password', 'tooltip' => ''],
        'passwordConfirmation' => ['label' => 'passwordConfirmation', 'placeholder' => 'passwordConfirmation', 'helper_text' => 'passwordConfirmation', 'description' => 'passwordConfirmation', 'tooltip' => ''],
