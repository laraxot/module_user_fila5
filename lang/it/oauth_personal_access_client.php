...
return [
    ...
    'actions' => [
        'create' => ['label' => 'Crea Personal Access Client', 'tooltip' => 'Crea un nuovo personal access client', 'helper_text' => 'Crea un nuovo personal access client', 'description' => 'Azione per creare', 'success' => 'Personal Access Client creato con successo', 'error' => 'Errore durante la creazione del Personal Access Client'],
        'edit' => ['label' => 'Modifica Personal Access Client', 'tooltip' => 'Modifica il personal access client', 'helper_text' => 'Modifica il personal access client', 'description' => 'Azione per modificare', 'success' => 'Personal Access Client aggiornato con successo', 'error' => 'Errore durante l\'aggiornamento del Personal Access Client'],
        'delete' => ['label' => 'Elimina Personal Access Client', 'tooltip' => 'Elimina il personal access client', 'helper_text' => 'Elimina il personal access client', 'description' => 'Azione per eliminare', 'success' => 'Personal Access Client eliminato con successo', 'error' => 'Errore durante l\'eliminazione del Personal Access Client', 'confirmation' => 'Sei sicuro di voler eliminare questo Personal Access Client?'],
