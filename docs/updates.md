...
created: 2026-07-14
updated: 2026-07-14
qmd: "updates user module updates - december 2025"
...
## PHPStan Fixes
- **DocBlock Updates**: Fixed `class.notFound` errors in `User` and `TenantUser` models by replacing non-existent `PlanningModule\Models\Profile` references with `Modules\Xot\Contracts\ProfileContract`.
