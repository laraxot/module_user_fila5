...
│  │  Redirect URL:  http://application.local/auth/google/...│  │
│  │                                                       │  │
...
return array (
  ...
  array (
    ...
    'redirect' => 'https://application.local/auth/google/callback',
    'scopes' => 
    array (
      0 => 'openid',
      1 => 'email',
  ...
  array (
    ...
    'client_id' => '',
    'client_secret' => '',
    'redirect' => 'https://application.local/auth/github/callback',
  ),
);
```
...
2. Create new project: "Application OAuth"
...
3. App name: "Application"
4. User support email: support@application.local
5. Developer contact: dev@application.local
...
4. Name: "Application Web"
5. Authorized JavaScript origins: `https://application.local`
6. Authorized redirect URIs: `https://application.local/auth/google/callback`
7. Click **Create**
8. Copy **Client ID** and **Client Secret**

### Step 4: Configure in Application Admin
...
**Cause**: Redirect URL in Google Console doesn't match Application config.
