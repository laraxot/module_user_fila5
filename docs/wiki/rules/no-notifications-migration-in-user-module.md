...
## Se manca tabella su `application_user`
...
- [main-module-profiles-ownership](../../../Application/docs/wiki/concepts/main-module-profiles-ownership.md) (stesso pattern boundary)
