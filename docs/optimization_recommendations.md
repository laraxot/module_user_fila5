...
- **141+ occorrenze hardcoded** di "application" 
...
3. **Documentation**: Rimuovere path hardcoded tipo `[project-root]/`
...
### Riusabilità
- [ ] **0 occorrenze** hardcoded "application"
...
grep -r -i "application" Modules/User/ --include="*.php" | wc -l
```
