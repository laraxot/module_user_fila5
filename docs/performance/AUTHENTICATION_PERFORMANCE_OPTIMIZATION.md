<<<<<<< HEAD
---
title: "Rimando a authentication_performance_optimization.md"
description: "Documento unificato: il contenuto canonico vive in authentication_performance_optimization.md."
status: merged
