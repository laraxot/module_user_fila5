...
namespace Modules\Application\app\Providers\Filament;
...
class AdminPanelProvider extends XotBasePanelProvider
{
    ...
    private function getFullCalendarPlugin(): FilamentFullCalendarPlugin
    {
        ...
        return $plugin->config([
            ...
            // Configurazioni specifiche per Application
            'locale' => 'it',
...
La gestione delle licenze FullCalendar Scheduler richiede attenzione particolare, specialmente in ambienti di produzione sanitari come Application. Seguire questa guida garantisce una configurazione corretta e la risoluzione dei problemi più comuni.
