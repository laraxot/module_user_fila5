...
```
/var/www/html/ptvx/laravel/Themes/One/resources/views/pages/auth/logout.blade.php (docs: replace project-specific references with generic placeholders across documentation)
```
