...
Laraxot utilizza il package `spatie/laravel-queueable-action` per le Actions, NON il pattern Service: (docs: replace project-specific references with generic placeholders across documentation)
