...
describe('LoginWidget', function (): void {
    ...
    test('login widget has correct form schema', function (): void {
        $widget = new LoginWidget();
        $schema = $widget->getFormSchema(); // @phpstan-ignore method.deprecated (hook di progetto: la deprecazione e ereditata per nome dal prototipo Filament 5, il codice eseguito e il nostro — story 16.12)
